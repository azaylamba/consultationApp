Hello folks, we will be building our own expert consultation app. You have to design & build the backend for the application and the ability for the users to register and book appointments with experts.
...
https://github.com/azaylamba/consultationApp 
